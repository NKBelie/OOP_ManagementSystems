...
public class Invoice extends Payment {
    ...
    public Invoice(int id, String createdDate, String updatedDate, String companyName, String address, String phoneNumber,
        ...
        if (totalCharge <= 0) {
            throw new VehicleDataException("27174: Total charge must be greater than 0");
        }
    ...
    public void setTotalCharge(double totalCharge) throws VehicleDataException {
        if (totalCharge <= 0) throw new VehicleDataException("27174: Total charge must be greater than 0");
        this.totalCharge = totalCharge;
    }
}
