...
public class Feedback extends Bill {
    ...
    public Feedback(int id, String createdDate, String updatedDate, String hotelName, String address, String phoneNumber, String email,
        ...
        if (rating < 1 || rating > 5) {
            throw new HotelDataException("27174: Rating must be between 1 and 5");
        }
        this.rating = rating;
    ...
    public void setRating(int rating) throws HotelDataException {
        if (rating < 1 || rating > 5) throw new HotelDataException("27174: Rating must be between 1 and 5");
        this.rating = rating;
    }
