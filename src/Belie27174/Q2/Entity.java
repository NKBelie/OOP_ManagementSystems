...
public class Entity {
    ...
    public void setCreatedDate(String createdDate) throws SchoolDataException {
        if (createdDate == null || createdDate.trim().isEmpty()) throw new SchoolDataException("Created date cannot be null or empty");
        this.createdDate = createdDate;
    }
    public String getUpdatedDate() { return updatedDate; }
    public void setUpdatedDate(String updatedDate) throws SchoolDataException {
        if (updatedDate == null || updatedDate.trim().isEmpty()) throw new SchoolDataException("Updated date cannot be null or empty");
        this.updatedDate = updatedDate;
    }
}